...
public class ConfigurationModelRepresenter extends Representer {
    ...
    List<String> propertyOrder = Arrays.asList(
    		new String[]{
    				...
    				"testCases","testSteps","connectorRefs","testCaseName","testStepName","conRefId","payloads","fileName", // testcases top-level
    				"id","type","dsRefId","queue","query", "url","method","path","contentType", "userAgent","timeout", //  connectors
    				"qmgr","channel","host","port","user","password" //  ds
    		});
