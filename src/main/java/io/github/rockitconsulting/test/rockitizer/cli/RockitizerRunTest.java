...
public class RockitizerRunTest extends JUnitCore implements Runnable {
	public static final Logger LOGGER = Logger.getLogger(RockitizerRunTest.class.getName());
	...
	public void run() {
		...
		System.out.println(CommandLine.Help.Ansi.AUTO.string("@|bold Result: |@")
				+ (sumErrors > 0 ? CommandLine.Help.Ansi.AUTO.string("@|bold,red NOK|@") : CommandLine.Help.Ansi.AUTO.string("@|bold,green OK|@")));
