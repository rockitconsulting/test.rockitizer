...
public class SplitCustomerTestErrorHandling extends AbstractTestWrapper {
	public static Logger logger = Logger.getLogger(SplitCustomerTestErrorHandling.class.getName());
	public TestBuilder testBuilder = newTestBuilderFor(SplitCustomerTestErrorHandling.class);
